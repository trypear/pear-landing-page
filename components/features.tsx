      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          >
            ...
            >
              <a
                className="btn w-full bg-primary-500 text-white-main hover:bg-primary-600 sm:w-auto"
                href="https://forms.gle/5APwrsWLZ8VTvuKE7"
              >
                Apply For Moderation Role
              </a>
              <a
                className="btn w-full bg-secondary-main text-white-main hover:bg-gray-800 sm:w-auto"
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <path
                  className="stroke-current text-white-main"
