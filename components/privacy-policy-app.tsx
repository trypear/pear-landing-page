        ...
        <div className="relative pb-10 pt-32 md:pb-16 md:pt-40">
          ...
          <div className="mx-auto max-w-3xl text-lg">
            ...
            <p className="mb-6 leading-relaxed text-gray-600">
              ...
              open-source software. However, if you choose to use PearAI&apos;s
              hosted services (e.g., PearAI Server), we store only the
              information you provide during registration, such as:
            </p>
            <ul className="mb-6 ml-8 list-disc leading-relaxed text-gray-600">
              <li>Name</li>
              <li>Email address</li>
              <li>Company name (if applicable)</li>
              <li>Other optional details you may provide</li>
            </ul>
            <p className="mb-6 leading-relaxed text-gray-600">
          ...
          <div className="mx-auto max-w-3xl text-lg">
            ...
            <p className="mb-6 leading-relaxed text-gray-600">
              ...
              recent update date is noted at the top of this policy.
            </p>
            <p className="mb-6 leading-relaxed text-gray-600">
              In the case of significant changes, we will make a prominent blog
              post outlining the changes and notify our users. We encourage you
