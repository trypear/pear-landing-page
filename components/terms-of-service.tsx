    ...
    <section>
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="relative pb-10 pt-32 md:pb-16 md:pt-40">
          {/* Section header */}
          <div className="mx-auto max-w-3xl text-left text-secondary-400 dark:text-gray-400 md:pb-16">
            <h1
              className="h1 text-gray-800 dark:text-gray-200"
              data-aos="fade-up"
            >
              Terms of Service
            </h1>
              ...
              <ol>
                ...
                <li>
                  <p>
                    ...
                    jurisdiction (e.g., 18 years old in the United States). By
                    agreeing to these Terms, you represent and warrant to us
                    that: (a) you are at least 18 years old; (b) you have not
                    previously been suspended or removed from the Service; and
                ...
                <li>
                  ...
                  <p>
                    ...
                    Service, and ending on the earlier of: (i) the effective
                    date of termination by either party in accordance with these
                    Terms, including when terminated as described in Section
                    11.2, or (ii) when no Order Form remains in effect, if you
                    and PearAI had previously executed an Order Form.
                  </p>
                  <p>
                    11.2.{" "}
                    <strong className="text-gray-700 dark:text-gray-300">
                ...
                <li>
                  <p>
                    ...
                    responsible for your use of the Service, and you will defend
                    and indemnify PearAI, its affiliates and their respective
                ...
                <li>
                  ...
                  <p>
                    ...
                    provision, and this Arbitration Agreement will be
