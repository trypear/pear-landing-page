          ...
          <div className="mb-8 grid gap-8 md:mb-12 md:grid-cols-12 lg:gap-20">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="flex items-center">
                ...
                <Link href="/privacy" className="ml-3 text-secondary-main">
                  Privacy Policy
                </Link>
            ...
            <ul className="mb-4 flex md:order-1 md:mb-0 md:ml-4">
              <li className="ml-4">
                <Link
                  ...
                  target="_blank"
                  className="flex items-center justify-center rounded-full bg-primary-500 text-secondary-main transition duration-150 ease-in-out hover:bg-primary-600 hover:text-gray-100"
                  aria-label="Github"
                >
                  <svg
              ...
              <li className="ml-4">
                <Link
                  ...
                  className="flex items-center justify-center rounded-full bg-primary-500 text-primary-500 transition duration-150 ease-in-out hover:bg-primary-600 hover:text-gray-100"
                  target="_blank"
