...
const BetaPage: React.FC<{ user: any }> = ({ user }) => {
  ...
  return (
    <section className="relative pt-8 sm:pt-12 md:pt-16 lg:pt-24" aria-label="beta downloads">
        ...
        <div className="flex flex-col items-center space-y-6 sm:space-y-8 md:space-y-6 lg:space-y-6">
          <header className="mx-auto mt-16 max-w-4xl space-y-4 text-center sm:mt-0 sm:space-y-6">
            <h1 className="mt-8 text-4xl font-medium leading-tight sm:text-4xl md:text-4xl lg:text-4xl">
              Download PearAI Beta
            </h1>
            <p className="text-lg text-gray-600">
              Try out the latest beta features and help us improve PearAI
            </p>
          </header>
            ...
            <div className="grid w-full max-w-4xl grid-cols-1 gap-8 md:grid-cols-2">
              <div className="flex flex-col items-center space-y-2">
                <Button
                  ...
                  style={gradientStyle}
                  onClick={() => window.location.href = "https://drive.google.com/drive/folders/1kQjtQkg8fScj-pFvVdUT1X9Bky41Kkl_?usp=sharing"}
                >
              ...
              <div className="flex flex-col items-center space-y-2">
                <Button
                  className={cn("rainbow-gradient", "font-bold", "w-full")}
                  onClick={() => window.location.href = "https://drive.google.com/drive/folders/1n74VC3FWArMf6Td9sf0wEVzb1jMBpim_?usp=drive_link"}
                >
