            ...
            <form onSubmit={(e) => handleOAuthSignUp('github')}>
              <div className="flex flex-wrap -mx-3">
                <div className="w-full px-3 mt-6">
                  <button className="btn px-0 text-white bg-gray-700 hover:bg-gray-600 w-full relative flex items-center" >
                    <svg aria-hidden="true" className="w-4 h-4 text-white opacity-75 shrink-0 mx-4" viewBox="0 0 16 16" width="24">
