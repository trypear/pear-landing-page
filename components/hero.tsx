  ...
  return (
    <section className="relative">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-20">
        ...
        >
          <Background />
          <VerticalLine className="relative bottom-[235px] h-[200px] w-px bg-[#00705A] opacity-30" />
        </motion.div>
        ...
        >
          <Background />
          <VerticalLine className="relative bottom-[235px] h-[200px] w-px bg-[#00705A] opacity-80" />
        </motion.div>
