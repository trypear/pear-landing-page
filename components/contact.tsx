    ...
    return (
        <section className="relative">
            <div className="mx-auto max-w-6xl px-4 sm:px-6">
                <div className="pb-12 pt-24 md:pb-16 md:pt-30">
                    <div className="md:pb-15 mx-auto max-w-3xl pb-4 text-center text-xl sm:text-2xl md:text-3xl lg:text-4xl">
                        <h1 className="text-3xl font-bold leading-tight sm:text-4xl md:text-5xl lg:text-6xl">
                            Looking for a <span className="text-primary-700">custom</span> pricing option? Get in touch!
                        </h1>
                    </div>
                    ...
                    <div className="mx-auto max-w-2xl">
                        ...
                        <div className="my-6 flex items-center">
                            <div
                                ...
                                aria-hidden="true"
                            />
                            <div className="text-gray-600">Please contact us using the form below</div>
                            <div
                        ...
                        <Form {...form}>
                            ...
                            >
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel htmlFor="first_name">First Name <span className="text-red-600"> *</span></FormLabel>
                                            <FormControl>
                                                <Input
                                                    id="first_name"
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel htmlFor="last_name">Last Name <span className="text-red-600"> *</span></FormLabel>
                                            <FormControl>
                                                <Input
                                                    id="last_name"
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel htmlFor="email">Work Email <span className="text-red-600"> *</span></FormLabel>
                                            <FormControl>
                                                <Input
                                                    id="email"
                                                    type="email"
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel htmlFor="job_title">Job Title <span className="text-red-600"> *</span></FormLabel>
                                            <FormControl>
                                                <Input
                                                    id="job_title"
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel htmlFor="company_name">Company Name <span className="text-red-600"> *</span></FormLabel>
                                            <FormControl>
                                                <Input
                                                    id="company_name"
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel htmlFor="organisation_size">
                                                Organisation Size <span className="text-red-600"> *</span>
                                            </FormLabel>
                                            <FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel htmlFor="message">Message <span className="text-red-600"> *</span></FormLabel>
                                            <FormControl>
                                                <textarea
                                                    id="message"
                                                    placeholder="Describe your needs here"
                                                    className="w-full h-36 p-3 border border-gray-200 rounded-md text-sm resize-none"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
