    ...
    <main className="min-h-screen">
      <div className="container mx-auto max-w-4xl px-6 pb-16 pt-32">
          ...
          <div className="rounded-xl bg-secondary-300/10 p-6">
            ...
            <ol className="list-inside list-decimal">
              ...
              <li className="mb-2">
                ...
                <pre className="bg-secondary mt-1 rounded-lg border-2 border-solid border-input p-2">
                  <span className="font-mono">
                    python3.9 -m pipx install --python python3.9
                    aider-chat==0.65.0
                  </span>
                </pre>
              </li>
          ...
          <div className="mt-4 rounded-xl bg-secondary-300/10 p-6">
            ...
            <ol className="list-inside list-decimal">
              ...
              <li className="mb-2">
                ...
                <pre className="bg-secondary mt-1 rounded-lg border-2 border-solid border-input p-2">
                  <span className="font-mono">
                    pipx install --python python3.9 aider-chat==0.65.0
                  </span>
                </pre>
              </li>
              <li>
        ...
        <div className="mb-8 rounded-xl bg-secondary-300/10 p-6">
          ...
          <p className="mb-4">
            If you already have aider installed but PearAI Creator is still not
            working, this is likely due to aider being installed with a
            different package manager than pipx. Please follow these steps to
            fix the issue:
          </p>
          <ol className="list-inside list-decimal">
            <li className="mb-4">
            ...
            <li className="mb-2">
              <strong>
                Then, follow the Manual Installation Instructions above
              </strong>{" "}
              for your operating system to ensure a clean installation of the
              correct version
            </li>
          </ol>
        </div>
