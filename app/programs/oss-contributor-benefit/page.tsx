      ...
      <section className="mx-auto mt-36 flex w-full max-w-3xl flex-col items-center px-4">
        <div className="mb-16 text-center">
          ...
          <p className="mb-6 whitespace-pre-line text-base text-gray-600">
            ...
            working together to help anyone build software. Whether you&apos;re
            a student looking to enhance your resume, a coding enthusiast, or a
            PearAI user hoping to improve the product, we welcome and value your
            contributions!
          </p>
          ...
          <div className="mx-auto mb-8 mt-6 max-w-2xl rounded-xl border border-primary-100 bg-gray-50 p-6 shadow-sm">
            ...
            <ul className="mb-2 list-disc space-y-1 pl-6 text-left text-base text-gray-700">
              ...
              <li>
                <b>Community impact:</b> Help make software creation accessible
                to everyone. Join an active, supportive developer community.
                Receive recognition in weekly community shoutouts.
              </li>
            </ul>
          </div>
          <div className="mx-auto mb-8 mt-6 max-w-2xl rounded-xl border border-primary-100 bg-gray-50 p-6 shadow-sm">
