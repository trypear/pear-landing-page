...
export const Contributing: React.FC = () => {
  return (
    <div>
      ...
      <div>
        <li className="mt-[-290px] pl-16">An AI-powered code editer</li>
        <li className="pl-16 pt-5">
        ...
        <h2 className="font-architects-daughter ml-40 pt-40 text-3xl font-semibold leading-tight tracking-tighter">
          - Our mission is to make the best AI-powered code editor
        </h2>
      </div>

      <div className="flex justify-center">
        <h1 className="font-architects-daughter pt-80 text-5xl font-extrabold leading-tight tracking-tighter">
